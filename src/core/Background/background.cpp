...
/*!
 * @brief Returns a linear interpolation between two colors
 * @param A First color. The more t gets closer to 0, the more the returned color gets closer to A.
 * @param B Second color. The more t gets closer to 1, the more the returned color gets closer to B.
 * @param t Real value that interpolater between the first and second color. 
 * @return The interpolated color between A and B.
 */
...
/*!
 * @brief Creates a texture background from the filename in the parameters
 * @param ps parameters of the tag.
 * @return A shared pointer to the Background created
 */
